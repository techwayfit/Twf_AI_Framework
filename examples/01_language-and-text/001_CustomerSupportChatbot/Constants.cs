...
namespace _001_CustomerSupportChatbot
{
    public static class Constants
    {
        ...
        public static class Prompts
        {
            ...
            public const string BasicSupportPrompt = "You are a helpful customer support agent for {{company_name}}. Answer the user's question based on the information provided.";
